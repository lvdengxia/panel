<template>
  <div class="le-card">
    <div class="le-header">
      ...
      <el-button type="primary" @click="routerEdit()" class="le-header__btn"
        >添加商品服务</el-button
      >
    </div>
              ...
              <div class="el-popconfirm">
                ...
                <div class="el-popconfirm__action">
                  <el-button size="mini" type="text" @click="cancel"
                    >取消</el-button
                  >
                  <el-button size="mini" type="primary" @click="sortChange"
                    >确定</el-button
                  >
                </div>
              </div>
        ...
        <template slot-scope="scope">
          <div class="flex align-center le-edit">
            ...
            <popconfirm
              width="330px"
              @confirm="
                deleteService({ id: scope.row.id, index: scope.$index })
              "
              title="确认删除该条商品服务？"
            >
