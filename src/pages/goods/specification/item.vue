  ...
  <div class="specification-item">
    ...
    <div class="specification-item__content">
      ...
      <div class="specification-item__list">
        <div
          class="specification-item__input"
          ...
          <div class="specification-item__cover" v-if="checked && is_cover">
            <pictureDialog v-model="item.image" @blur="handleImageSync">
              <div slot="upload" class="specification-item__cover-add">
                <i
                  class="le-icon le-icon-add specification-item__cover-icon"
                ></i>
              ...
              <div
                slot="preview"
                slot-scope="scope"
                class="specification-item__cover-edit"
              >
