<template>
  ...
  >
    <div class="le-prompt">
      ...
      商品采集设置：<span class="le-prompt-router" @click="router()"
        >商品采集-接口设置</span
      >
    </div>
    <div class="le-form">
      ...
      <el-form-item label="商品图片">
        ...
        <div class="le-prompt-text">
          选择使用图片链接，则采集平台的商品图片失效时，图片链接也将失效
        </div>
      </el-form-item>
    ...
    <div class="le-cardpin">
      <el-button type="primary" @click="saveForm" :disabled="loading"
        >保存</el-button
      >
    </div>
  </el-form>
