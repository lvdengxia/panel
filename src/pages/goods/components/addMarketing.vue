<template>
  <div>
    <el-form-item label="发放优惠券">
      <div class="le-coupon">
        ...
        >
          ...
          <i
            ...
            @click="value.coupon.splice(index, 1)"
          ></i>
        </div>
      </div>
      <div class="flex">
        ...
        <div class="flex align-center">
          <he-link href="application/play/coupon/detail" target="_blank">
      ...
      <div class="he-tips" style="padding-left: 0; clear: both">
        购买此商品支付成功后，将自动发放优惠券
      </div>
    </el-form-item>
  </div>
