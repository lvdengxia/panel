      ...
      <el-col :span="12">
        <el-autocomplete
          ...
          @keydown.enter.native="
            handleSelect(null, 'searchChoose', 'searchList')
          "
          @clear="
            (cat) => {
        ...
        <div class="le-cat__body-item-list">
          <el-scrollbar style="height: 250px">
            ...
            >
              ...
              <el-checkbox
                @change="optionClick(item)"
                v-model="item.checked"
                v-else
              ></el-checkbox>
              <div
                class="le-cat__body-item-label el-row--flex is-justify-space-between is-align-middle"
              >
                <span>
                  {{ item.name }}
                </span>
...
export default {
  ...
  methods: {
    ...
    catBuild() {
      ...
      this.second = this.first[this.current1].children
        ? this.first[this.current1].children
        : [];
      this.third =
        this.second[this.current2] && this.second[this.current2].children
          ? this.second[this.current2].children
          : [];
    },
    /**
     * 控制分类显示隐藏
                  ...
                  if (v.id == arr[1]) {
                    ...
                    this.first[k].children.forEach((v1, k1) => {
                      if (v1.id == arr[2]) {
                        this.current2 = k1;
                        show_val2 = { is_run: true, show: false, index: k1 };
                        this.first[k].children[k1].children.forEach(
                          (v2, k2) => {
                            if (v2.id == cat.id) {
                              show_val3 = {
                                is_run: true,
    ...
    optionClick(item) {
      ...
      if (sign && item.checked) {
        ...
        if (level === 3) {
          item.value =
            this.nameList[path[1]].name +
            ">" +
            this.nameList[path[2]].name +
            ">" +
            item.name;
