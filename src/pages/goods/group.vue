    ...
    <div class="flex">
      <div class="flex-sub">
        ...
        <div class="he-attr__body">
          ...
          <div class="he-group__empty" v-if="first.length === 0">
            该分类下暂无内容
          </div>
          <el-scrollbar style="height: 472px">
            <div
              ...
              :style="
                chooseIndex.first === index ? 'background-color:#F7F5FE;' : ''
              "
            ...
            >
              ...
              <div
                class="he-group__sort le_goods__main-goodstitle le_goods__main-sort"
              >
                {{ item.sort }}
                  ...
                  <div class="el-popconfirm">
                    ...
                    <div class="el-popconfirm__action">
                      <el-button
                        size="mini"
                        type="text"
                        @click.stop="cancel(index, 'first')"
                        >取消
                      </el-button>
                      <el-button
                        size="mini"
                        type="primary"
                        @click.stop="sortChange(index, 'first')"
                        >确定
                      </el-button>
                    </div>
                  </div>
              ...
              <div class="he-group__handle">
                <he-link href="goods/groupPublish" :query="{ id: item.id }">
                  <el-popover placement="top" trigger="hover" content="编辑">
                    <i
                      slot="reference"
                      class="le-icon le-icon-fenlei-bianji"
                    ></i>
                  </el-popover>
                </he-link>
      ...
      <div class="flex-sub">
        ...
        <div class="he-attr__body">
          ...
          <div class="he-group__empty" v-if="second.length === 0">
            该分类下暂无内容
          </div>
          <el-scrollbar style="height: 472px">
            <div
              ...
              :style="
                chooseIndex.second === index ? 'background-color:#F7F5FE;' : ''
              "
                  ...
                  <div class="el-popconfirm">
                    ...
                    <div class="el-popconfirm__action">
                      <el-button
                        size="mini"
                        type="text"
                        @click.stop="cancel(index, 'second')"
                      >
                        取消
                      </el-button>
                      <el-button
                        size="mini"
                        type="primary"
                        @click.stop="sortChange(index, 'second')"
                        >确定
                      </el-button>
                    </div>
                  </div>
      ...
      <div class="flex-sub">
        ...
        <div class="he-attr__body">
          ...
          <div class="he-group__empty" v-if="third.length === 0">
            该分类下暂无内容
          </div>
          <el-scrollbar style="height: 472px">
            <div
                  ...
                  <div class="el-popconfirm">
                    ...
                    <div class="el-popconfirm__action">
                      <el-button
                        size="mini"
                        type="text"
                        @click.stop="cancel(index, 'third')"
                        >取消
                      </el-button>
                      <el-button
                        size="mini"
                        type="primary"
                        @click.stop="sortChange(index, 'third')"
                        >确定
                      </el-button>
                    </div>
                  </div>
...
export default {
  ...
  methods: {
    ...
    listBuild() {
      ...
      this.second = this.first[this.chooseIndex.first].children
        ? this.first[this.chooseIndex.first].children
        : [];
      this.third =
        this.second[this.chooseIndex.second] &&
    ...
    getSearch() {
      ...
      if (this.search) {
        ...
        if (search_value) {
          ...
          if (level > 2) {
            this.first[this.chooseIndex.first].children[
              [this.chooseIndex.second]
            ].children.forEach((v2, k2) => {
