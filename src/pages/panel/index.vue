  ...
  <el-scrollbar class="le-matter le-panel">
    <div class="le-index--content">
      <div class="flex le-content__top">
        <div
          class="le-top__store le-panel__card flex flex-direction align-center"
        >
          <div class="le-store__sign">
            <el-image
              style="width: 80px; height: 80px; border-radius: 50%"
              :src="getStore.logo" alt="logo"
            >
        ...
        <div class="le-top__router flex-sub">
          <div class="le-router__top flex">
            <div class="le-panel__card flex le-router__top-left">
              <div
                class="flex-sub flex flex-direction align-center justify-center"
              >
          ...
          <div class="le-router__bottom le-panel__card">
            ...
            <div class="le-router__bottom--body flex">
              <div class="le-entrance flex-sub flex">
                <div
                  class="le-entrance__router flex align-center"
                  @click="router(4)"
                >
                  <img
                    src="./image/release-goods.png"
                    alt=""
                    class="le-entrance__img"
                  />
              ...
              <div class="le-entrance flex-sub flex">
                ...
                >
                  <img
                    src="./image/store-construction.png"
                    alt=""
                    class="le-entrance__img"
                  />
              ...
              <div class="le-entrance flex-sub flex">
                ...
                >
                  <img
                    src="./image/order-management.png"
                    alt=""
                    class="le-entrance__img"
                  />
            ...
            <el-table-column label="排名" width="55">
              <template slot-scope="scope">
                <div class="flex justify-start align-center">
                  <span
                    v-if="
                      (sale_page.current - 1) * sale_page.size +
                        scope.$index +
                        1 >
                      3
                    "
            ...
            <el-table-column label="排名" width="55">
              <template slot-scope="scope">
                <div class="flex justify-start align-center">
                  <span
                    v-if="
                      (buyer_page.current - 1) * buyer_page.size +
                        scope.$index +
                        1 >
                      3
                    "
              ...
              <template slot-scope="scope">
                <div class="flex align-center">
                  ...
                  <el-popover
                    ...
                    trigger="hover"
                    :content="
                      scope.row.oauth && scope.row.oauth.type === 'weapp'
                        ? '小程序'
                        : '公众号'
                    "
                  >
                    ...
                    <he-icon
                      ...
                      size="18px"
                      v-if="
                        scope.row.oauth && scope.row.oauth.type === 'wechat'
                      "
                      type="le-icon-wehcat"
                    ></he-icon>
                  </el-popover>
      ...
      <div class="le-panel__footer">
        <div class="le-link">
          <span>官网</span>丨
          <span>
            <a href="http://forum.leadshop.vip/" target="_blank">论坛</a> </span
          >丨
          <span>文档</span>
        </div>
...
export default {
  ...
  methods: {
      ...
      this.$heshop
        ...
        .then(function (res) {
          ...
          _this[page] = {
            ...
            count:
              +headers["x-pagination-page-count"] > 10
                ? 10
    ...
    sortBuyer: function (e) {
      ...
      this.buyer_keyword.sort[e.prop] =
          ...
          require.ensure([], function () {
            _this.$h.Export2Excel.export_json_to_excel({
              ...
              filename:
                name +
                "报表(" +
                _this.$moment(new Date()).format("YYYYMMDDHHmmss") +
                ")",
            });
          });
        })
