    ...
    <div class="le-card" style="margin-bottom: 24px">
      ...
      <div class="he-statistics flex">
        ...
        <div class="he-statistics__item flex-sub">
          ...
          <div>
            <span class="he-statistics__number">{{
              statistics.user_grow_today.all
            }}</span>
            <el-popover
              placement="right"
              title="今日新增用户数"
          ...
          <div class="he-statistics__Yesterday">
            昨日 {{ statistics.user_grow_yesteday.all }}
          </div>
        </div>
        <div class="he-statistics__item flex-sub">
...
export default {
  ...
  methods: {
    ...
    getKeyword: function () {
      ...
      let last_buy_time_end_str = last_buy_time_end
        ? last_buy_time_end.toString()
        : "";
      last_buy_time_end_str = last_buy_time_end_str.slice(
        0,
        last_buy_time_end_str.length - 3
      );
      let created_time_start_str = created_time_start
        ? created_time_start.toString()
        : "";
      created_time_start_str = created_time_start_str.slice(
        0,
        created_time_start_str.length - 3
      );
      let created_time_end_str = created_time_end
        ? created_time_end.toString()
        : "";
      created_time_end_str = created_time_end_str.slice(
        0,
        created_time_end_str.length - 3
      );
      let last_buy_time_start_str = last_buy_time_start
        ? last_buy_time_start.toString()
        : "";
      last_buy_time_start_str = last_buy_time_start_str.slice(
        0,
        last_buy_time_start_str.length - 3
      );
      let last_visit_time_start_str = last_visit_time_start
        ? last_visit_time_start.toString()
        : "";
      last_visit_time_start_str = last_visit_time_start_str.slice(
        0,
        last_visit_time_start_str.length - 3
      );
      let last_visit_time_end_str = last_visit_time_end
        ? last_visit_time_end.toString()
        : "";
      last_visit_time_end_str = last_visit_time_end_str.slice(
        0,
        last_visit_time_end_str.length - 3
      );
      return {
    ...
    search: function (keyword) {
      ...
      keyword["created_time_start"] = keyword["created_time_start"]
        ? keyword["created_time_start"] / 1000
        : null;
      keyword["created_time_end"] = keyword["created_time_end"]
        ? keyword["created_time_end"] / 1000
        : null;
      keyword["last_buy_time_start"] = keyword["last_buy_time_start"]
        ? keyword["last_buy_time_start"] / 1000
        : null;
      keyword["last_buy_time_end"] = keyword["last_buy_time_end"]
        ? keyword["last_buy_time_end"] / 1000
        : null;
      keyword["last_visit_time_start"] = keyword["last_visit_time_start"]
        ? keyword["last_visit_time_start"] / 1000
        : null;
      keyword["last_visit_time_end"] = keyword["last_visit_time_end"]
        ? keyword["last_visit_time_end"] / 1000
        : null;
      keyword.label = [];
