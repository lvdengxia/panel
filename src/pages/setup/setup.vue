    ...
    >
      ...
      <div class="le-card">
          ...
          <div class="select-cover__120">
            <pictureDialog v-model="ruleForm.store_setting.logo" :limit="1">
              ...
              <div
                slot="preview"
                slot-scope="scope"
                class="select-cover__120-edit"
              >
                <el-image :src="scope.url" fit="cover"></el-image>
                <div class="select-cover__120-tips">
                  <span>替换</span> |
                  <span @click.stop="(e) => (ruleForm.store_setting.logo = '')"
                    >删除</span
                  >
                </div>
              </div>
        ...
        <el-form-item label="联系我们" class="le-store-contact">
          ...
          <div class="le-banner-phone">
            <el-checkbox
              v-model="ruleForm.store_setting.contact.phone.bool"
              disabled
              >电话联系</el-checkbox
            >
          </div>
          <div>
            ...
            <div>
              <div class="flex le-item">
                ...
                <!-- <div>
                  <el-checkbox-group
                    v-model="ruleForm.store_setting.contact.phone.day"
                  >
          ...
          <div class="le-banner-phone">
            <el-checkbox v-model="ruleForm.store_setting.contact.online.bool"
              >在线客服</el-checkbox
            >
          </div>
          <div v-if="ruleForm.store_setting.contact.online.bool">
            <div class="flex le-item">
              ...
              <!-- <div>
                <el-checkbox-group
                  :disabled="!ruleForm.store_setting.contact.online.bool"
                  v-model="ruleForm.store_setting.contact.online.day"
                >
                  <el-checkbox :label="1">周一</el-checkbox>
                  <el-checkbox :label="2">周二</el-checkbox>
                  <el-checkbox :label="3">周三</el-checkbox>
                ...
                <div class="le-prompt-text">示例：周一、周二 08:00至16:00</div>
              </div> -->
            </div>
          </div>
          <div class="le-banner-phone">
            <el-checkbox v-model="ruleForm.store_setting.contact.friend.bool"
              >加好友联系</el-checkbox
            >
          </div>
          <template v-if="ruleForm.store_setting.contact.friend.bool">
            <div class="le-item flex">
              ...
              <div>
                <div class="select-cover__120">
                  <pictureDialog
                    v-model="ruleForm.store_setting.contact.friend.pic_url"
                    :limit="1"
                  >
                    <div slot="upload" class="select-cover__120-add">
                      <i class="le-icon le-icon-add select-cover__120-icon"></i>
                    ...
                    >
                      ...
                      <div class="select-cover__120-tips">
                        ...
                        <span
                          @click.stop="
                            (e) =>
                              (ruleForm.store_setting.contact.friend.pic_url =
                                '')
                          "
                          >删除</span
                        >
            ...
            <div class="flex le-item">
              ...
              <!-- <div>
                <el-checkbox-group
                  :disabled="!ruleForm.store_setting.contact.friend.bool"
                  v-model="ruleForm.store_setting.contact.friend.day"
                >
                  <el-checkbox :label="1">周一</el-checkbox>
                  <el-checkbox :label="2">周二</el-checkbox>
                  <el-checkbox :label="3">周三</el-checkbox>
        ...
        <el-form-item label="详细地址" prop="store_setting.address">
          <el-input
            placeholder="请输入详细地址"
            v-model="ruleForm.store_setting.address"
          ></el-input>
        </el-form-item>
      </div>
      <div class="le-card">
        ...
        <el-form-item label="待付款订单自动取消">
          <el-switch
            v-model="ruleForm.trade_setting.cancel_status"
            :active-value="1"
            :inactive-value="0"
          ></el-switch>
        </el-form-item>
        <el-form-item
          label="待付款订单取消时间"
          v-if="ruleForm.trade_setting.cancel_status === 1"
        >
          <el-input
            v-model="ruleForm.trade_setting.cancel_time"
            @keyup.native="
              ruleForm.trade_setting.cancel_time = oninput(
                ruleForm.trade_setting.cancel_time
              )
            "
          >
        ...
        <el-form-item label="自动确认收货时间">
          <el-input
            ...
            @keyup.native="
              ruleForm.trade_setting.received_time = proving(
                ruleForm.trade_setting.received_time
              )
            "
          >
        ...
        <el-form-item label="待评价订单默认好评时间">
          <el-input
            ...
            @keyup.native="
              ruleForm.trade_setting.evaluate_time = proving(
                ruleForm.trade_setting.evaluate_time
              )
            "
          >
            <template slot="append">天</template>
        ...
        <el-form-item label="售后时间">
          <el-input
            ...
            @keyup.native="
              ruleForm.trade_setting.after_time = proving(
                ruleForm.trade_setting.after_time
              )
            "
          >
            <template slot="append">天</template>
      ...
      <div class="le-card">
        ...
        <el-form-item label="商品推荐">
          <div>
            <el-radio
              v-model="ruleForm.goods_setting.recommend_status"
              :label="1"
              >自动推荐</el-radio
            >
        ...
        <el-form-item label="商品推荐显示页面">
          <el-checkbox-group
            v-model="ruleForm.goods_setting.recommend_showpage"
          >
      ...
      <div class="le-card">
        <div class="el-row--flex is-align-middle">
          <span class="he-title-line"></span>
          <span class="he-title">定时任务</span>
        </div>
        <div class="le-line"></div>
        <div class="le-line"></div>
        <el-form-item label="优惠券定时任务">
          <el-input disabled :value="crontab"></el-input>
          <span @click="copy(crontab)" class="le-copy">复制链接</span>
          <div class="he-tips">
            请将定时任务链接，配置到服务器。
            <span class="le-copy">
              <a
                href="https://forum.leadshop.vip/thread/235"
                style="color: inherit"
                target="_blank"
                >查看配置教程</a
              ></span
    ...
    getSetting: function () {
      this.$heshop
        ...
        .then((res) => {
          ...
          data.goods_setting.recommend_goods === undefined
            ? (data.goods_setting.recommend_goods = [])
            : null;
          let new_mobile_auth = [];
      ...
      this.$refs["ruleForm"].validate((valid) => {
        if (valid) {
          if (!this.ruleForm.store_setting.logo) {
            this.ruleForm.store_setting.logo =
              "https://qmxq.oss-cn-hangzhou.aliyuncs.com/home.png";
          }
          let basic_setting = JSON.parse(
            JSON.stringify(this.ruleForm.basic_setting)
          );
          ...
          let store_setting = JSON.parse(
            JSON.stringify(this.ruleForm.store_setting)
          );
          ...
          let trade_setting = JSON.parse(
            JSON.stringify(this.ruleForm.trade_setting)
          );
          let pay_way = {
            wechat: {
              title: "微信",
          ...
          let goods_setting = JSON.parse(
            JSON.stringify(this.ruleForm.goods_setting)
          );
          let recommend_showpage = {
            goodsinfo: {
              title: "商品详情",
          ...
          let mobile_auth = JSON.parse(
            JSON.stringify(this.ruleForm.mobile_auth)
          );
          let new_mobile_auth = {
            join_shopping_cart: {
              title: "加入购物车",
          ...
          let userinfo_auth = JSON.parse(
            JSON.stringify(this.ruleForm.userinfo_auth)
          );
          let new_userinfo_auth = {
            join_shopping_cart: {
              title: "加入购物车",
