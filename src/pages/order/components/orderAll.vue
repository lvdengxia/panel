      ...
      <div class="he-item" v-for="(item, index1) in value" :key="item.id">
        <el-row class="he-item__header">
          ...
          <el-col
            :span="3"
            type="flex"
            class="he-platform el-row--flex is-align-middle"
          >
            <he-icon
          ...
          <el-col
            :span="4"
            class="he-remarks el-row--flex is-justify-end is-align-middle"
          >
            <el-popover
        ...
        <el-row class="he-item__body el-row--flex">
          <el-col class="he-product" :span="10">
            <el-row
              class="he-goods"
              v-for="(good, index2) in item.goods.slice(0, 3)"
              :key="index2"
            >
              <el-col :span="16" class="el-row--flex">
                <div class="he-goods__img__box">
                  ...
                  ></el-image>
                  <he-link
                    href="order/afterDetail"
                    :query="{ order_goods_id: good.id }"
                  >
