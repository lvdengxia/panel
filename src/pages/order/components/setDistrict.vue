  ...
  <div>
    <el-row class="he-card" v-if="list.length > 0">
      ...
      <el-col :span="8">
        <div class="he-header">
          <el-checkbox
            @change="selectAll('district')"
            v-model="districtAll"
            :indeterminate="districtIndeterminate"
            >全选</el-checkbox
          >
        </div>
        <div class="he-body">
          <el-card
            ...
            shadow="never"
            v-if="
              list[p_index].list[c_index].list &&
              list[p_index].list[c_index].list.length > 0
            "
          >
...
export default {
  ...
  methods: {
    ...
    newList() {
      ...
      let list3 = this.value.unchecked ? this.value.unchecked : [];
      ...
      if (this.radio) {
        for (let p_index = 0; p_index < this.list.length; p_index++) {
          if (this.list[p_index].isIndeterminate) {
            ...
            for (
              let c_index = 0;
              c_index < this.list[p_index].list.length;
              c_index++
            ) {
    ...
    checkList(defaultList, edit, formDetail) {
      ...
      for (var i = 0; i < defaultList.length; i++) {
        ...
        if (typeof defaultList[i].list != "undefined") {
          defaultList[i].list = this.checkList(
            defaultList[i].list,
            new_edit,
            new_form
          );
    ...
    selectAllStatus() {
      ...
      for (
        let i = 0;
        i < this.list[this.p_index].list[this.c_index].list.length;
        i++
      ) {
      ...
      if (
        districtCount === this.list[this.p_index].list[this.c_index].list.length
      ) {
