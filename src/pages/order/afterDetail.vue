    ...
    >
      <el-row class="le-buyer-return-flow le-card he-info he-user-freight">
        ...
        <el-col
          ...
          :class="
            detail.user_freight_info.images.length > 0 ? 'he-form__line' : ''
          "
        >
        ...
        <el-col
          :span="4"
          class="he-info__box"
          v-if="detail.user_freight_info.images.length > 0"
        >
    ...
    <template v-if="detail.type == 2 && detail.status == 200">
      <el-row class="le-buyer-return-flow le-card he-info">
        <el-col
          :span="6"
          class=""
          :class="detail.merchant_freight_info.type == 1 ? 'he-form__line' : ''"
        >
          ...
          >
            ...
            <div
              ...
              v-if="detail.merchant_freight_info.type === 1"
            >
              <div class="he-info__item">
                <span class="he-label"> 物流公司: </span>
                <span class="he-value">
            ...
            <el-col :span="8" class="he-info__box he-form__line">
              ...
              <div class="he-info__content">
                <div class="he-info__item">
                  ...
                  <span
                    @click="router(detail.order.id)"
                    class="he-value he-order-number"
                  >
                ...
                <div class="he-info__item">
                  ...
                  <span class="he-value"> ￥{{ detail.return_amount }} </span>
                </div>
                <div
                  class="he-info__item"
                  v-if="detail.order.status >= 202 && detail.order.freight"
                >
            ...
            <el-col :span="8" class="he-info__box" style="padding-right: 50px">
              ...
              >
                ...
                >
                  <li
                    :key="index"
                    class="he-timeline-item"
                    v-for="(item, index) in detail.process"
                  >
                    <div
                      class="he-timeline-item__tail"
                      v-if="index !== detail.process.length - 1"
                    ></div>
        ...
        <el-card class="le-form-card">
          <el-table :data="[detail.goods]" style="width: 100%">
            ...
            <el-table-column label="单价" width="280">
              <template slot-scope="scope">
                <div class="he-price-number">￥{{ scope.row.goods_price }}</div>
              </template>
            </el-table-column>
                ...
                <div class="he-total-amount">
                  {{
                    detail.status == 201
                      ? "--"
                      : "￥" +
                        (detail.actual_refund ? detail.actual_refund : "0.00")
                  }}
                </div>
              </template>
            </el-table-column>
      ...
      this.$heshop
        ...
        .then((res) => {
          ...
          if (
            res.type == 2 &&
            res.status == 200 &&
            res.merchant_freight_info.type == 1
          ) {
            this.$heshop
              .express("post", {
