                                ...
                                <li v-for="(item, key) in groupList" :key="key">
                                    <el-radio class="picture-selet__detail-radio" :label="key">
                                        ...
                                        <el-input placeholder="请输入内容" v-model="item.name" v-if="is_edit===item.id">
                                            <el-button slot="append" type="primary" @click="(e)=>{UpdateGroupItem(item);is_edit=-1}">确认
                                            </el-button>
                                        </el-input>
            ...
            <div class="picture-selet__layout">
                ...
                <div class="picture-selet__content" :style="{height:limit>1?'355px':'486px'}">
                    ...
                    <div class="picture-selet__paging">
                        <el-pagination background layout="prev, pager, next,jumper" :page-size="pageInfo.size" :current-page="pageInfo.current" :total="pageInfo.total" @current-change="handleSizeChange"></el-pagination>
                    </div>
                </div>
            </div>
        </div>
            ...
            <ul>
                ...
                <li v-for="(item,key) in checkedData" :key="key">
                    <div class="picture-selet__footer-image">
                        ...
                        <i class="le-icon le-icon-cha2 picture-selet__footer-close" @click="()=>{checkedData.splice(key, 1)}"></i>
                    </div>
                </li>
            </ul>
        </div>
