               ...
               <template v-if="content.autoplay === 0">
                ...
                <template v-else>
                    <div class="le-coupon-num">
                        ...
                        <el-input  v-model.number="content.number" :maxlength="2" @input="inputNumber" placeholder="请输入10以内的整数"></el-input>
                    </div>
                </template>
            </el-form>
        </template>
        <template slot="style">
            <el-form ref="form" :model="facade" @submit.native.prevent label-width="90px" size="mini"
                     label-position="left">
