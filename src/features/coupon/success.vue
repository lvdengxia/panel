 ...
 * @Description: 
 * @Author: fjt
 * @Date: 2021-05-26 16:26:19
 * @LastEditTime: 2021-05-26 17:02:51
 * @LastEditors: fjt
-->
<template>
  <div class="le-matter">
    ...
    <div
      class="le-success flex flex-direction align-center"
      v-loading="loading"
    >
      <template v-if="!loading">
        <img class="le-success-icon" src="./image/coupon-success-icon.png" />
        <div class="le-success-text">
          优惠券{{ $route.query.isEdit ? "编辑" : "创建" }}成功
        </div>
        <el-button
        ...
        <div class="le-table-edit flex align-center">
          <span
            ...
            @click="router('/features/coupon/detail')"
            >继续添加</span
          >
          <span class="le-line-text"></span>
          <span class="le-button-text" @click="router('/features/coupon/index')"
            >优惠券管理</span
          >
        </div>
      </template>
