    ...
    <el-container class="apply-body">
        <el-header class="apply-header" height="64px" style="background-color: rgb(34, 34, 34);">
            ...
            <div class="apply-header__logout" v-if="visible" @mouseenter="visible = true" @mouseleave="visible = false">
                ...
                <div class="footer-item" module="index" title="修改密码" action="handleLogout" v-popup.changePassword width="524">
                    <i class="le-icon le-icon-xiugaimima"></i> <span>修改密码</span>
                </div>
                <div class="footer-item" @click="handleLogout" v-if="is_form !='w7'">
