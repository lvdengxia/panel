                    ...
                    <ul>
                        <li v-for="item,index in classify">
                            <label class="photo-selet__detail-radio">
                                <input class="photo-selet__detail-input" type="radio" :value="item.id" v-model="uploader.selectClassify">
                ...
                <ul>
                    <li v-for="item,index in pictures">
                            ...
                            <div class="photo-selet__content-item">
                                <div class="photo-selet__content-item-photo">
                                    <div class="photo-selet__content-item-image">
                                        <div class="photo-selet__content-item-cover" :style="{
                        ...
                        <label class="photo-selet__content-label" v-if="item.type === 1">
                            <input class="photo-selet__content-input" type="radio" :value="item.url" v-model="uploader.selectPicture">
                            <div class="photo-selet__content-item">
...
export default {
    ...
    methods: {
         ...
         */
        handleChange(e) {
            this.handlePictures({ id: e.id, current: 1 , pageSize: 15}).then(data => {
