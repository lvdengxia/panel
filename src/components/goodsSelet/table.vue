<template>
    <div class="goods-selet__table">
        ...
        <div class="goods-selet__goodspage">
            <el-pagination @current-change="handleSizeChange" layout="prev, pager, next,jumper" 
                background
            :page-size="pageInfo.size" :current-page="pageInfo.current" :total="pageInfo.total"></el-pagination>
        </div>
    </div>
</template>
